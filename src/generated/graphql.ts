...
export type PaymentPdfQuery = { __typename?: 'Query', payment: { __typename?: 'Payment', counter: number, date: number, amount: number, member: { __typename?: 'Member', name: string, surname: string, taxCode: string, parent?: { __typename?: 'Parent', name: string, surname: string, taxCode: string } | null }, fee: { __typename?: 'Fee', name: string, type?: FeeTypeEnum | null } } };
