...
export type MembersCsvQuery = { __typename?: 'Query', members: { __typename?: 'MemberPagination', data: Array<{ __typename?: 'Member', name: string, surname: string, taxCode: string, csenCardNumber?: string | null }> } };
